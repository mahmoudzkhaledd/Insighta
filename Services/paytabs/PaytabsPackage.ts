...
const config: ConfigsProps = { merchantId: '', serverKey: '', region: '' }

exports.setConfig = ({ merchantId, serverKey, region }: ConfigsProps) => {
...
exports.createPaymentPage = ({ payment_code, transaction, cart, customer, shipping, urls, lang, callbackFunction, framed }: CreatePaymentPageProps) => {
